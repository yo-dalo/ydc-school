...
export default function AdmissionSection() {
  ...
  return (
    <section className="w-full relative bg-linear-to-br from-blue-900 via-blue-800 to-indigo-900 py-24 overflow-hidden">
      ...
      <div className="absolute -top-40 -right-40 w-96 h-96 bg-blue-500  blur-3xl opacity-30"></div>

      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 grid lg:grid-cols-2 gap-16 items-center">

        <div className="text-white">
          <span className="inline-block py-1.5 px-4  bg-white/10 backdrop-blur-md text-blue-100 text-sm font-bold tracking-wider mb-6 border border-white/20">
            JOIN US TODAY
          </span>
          ...
          <div className="flex flex-wrap gap-4 mt-8">
            <a
              ...
              className="bg-white text-blue-900 hover:bg-blue-50 px-8 py-4  font-extrabold shadow-xl hover:-translate-y-1 transition-all inline-block"
            >
              Apply For Admission
            </a>
            <button className="bg-transparent border-2 border-white/30 text-white hover:bg-white/10 px-8 py-4  font-bold transition-all">
              Download Guidelines
            </button>
          </div>
        </div>
        ...
        <div className="relative w-full h-96 lg:h-[500px]">
          {/* Decorative Frame */}
          <div className="absolute inset-4 -right-4 lg:-right-6 -bottom-4 lg:-bottom-6 border-2 border-dashed border-blue-400/50  z-0"></div>

          <div className="relative w-full h-full bg-white/10 backdrop-blur-md  border border-white/20 flex flex-col items-center justify-center p-8 text-center shadow-2xl overflow-hidden group">
            ...
            <div className="relative z-20 bg-blue-900/80 backdrop-blur-lg p-8  border border-white/10 shadow-2xl">
              <div className="w-16 h-16 bg-blue-500 text-white  flex items-center justify-center mx-auto mb-4">
